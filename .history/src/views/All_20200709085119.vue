<template>
  ...
  <div class="All_All">
    <div class="All">
      ...
      <div class="baby">
        <div v-for="item in list.slice((onChangePage - 1)* pageSize,onChangePage*pageSize)" :key="item.id" class="babyItem"
				:data="list.slice((onChangePage - 1)* pageSize,onChangePage*pageSize)"
				>
          <div class="imgAll">
...
console.log(this.list);
  ...
  computed: {
    ...
    total() {
      let sum = 0;
      sum = this.listOne.length + this.listTwo.length;
      console.log(sum);
      return sum;
    }
  }
