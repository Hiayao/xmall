      ...
      <div class="cardWord">
        ...
        <div class="other">
          <div class="otherTitle">其它账号登录:</div>
					<div class="icon"><img src="../assets/wechat.svg" alt="" class="ico"></div>
					<div class="icon"><img src="../assets/sina.svg" alt="" class="ico"></div>
					<div class="icon"><img src="../assets/qq.svg" alt="" class="ico"></div>
        </div>
      </div>
    </Card>
  </div>
