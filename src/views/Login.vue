      ...
      <div class="cardWord">
        ...
        <Form :model="formLeft" label-position="left" :label-width="100">
          ...
          <FormItem prop="passwd">
            <Input type="password" v-model="formLeft.passwd" password placeholder="密码" />
          </FormItem>
        </Form>
        <!-- 验证码 -->
        <div class="vpat">
        ...
        <div class="operation">
          ...
          <div class="forget">
            <div @click="gotoRegister" class="loginUp">注册XMall账号</div>
            <div style="font-weight:100">丨</div>
            <div class="getWord" @click="forget(false)">忘记密码?</div>
          </div>
        </div>
        <div class="btn">
        ...
        <div class="other">
          ...
          <div class="icon">
            <img src="../assets/wechat.svg" alt class="ico" @click="wait(false)" />
          </div>
          <div class="icon">
            <img src="../assets/sina.svg" alt class="ico" @click="wait(false)" />
          </div>
          <div class="icon">
            <img src="../assets/qq.svg" alt class="ico" @click="wait(false)" />
          </div>
        </div>
      </div>
    </Card>
